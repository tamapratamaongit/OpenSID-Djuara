...
<div id="contentpane">
<div class="ui-layout-center" id="chart-analisis" style="padding: 5px;"></div>
...
<div>
	<a class="btn btn-sm btn-primary mb-4 float-right"  href="<?php echo site_url()?>first/data_analisis" class="uibutton icon prev">Kembali</a>
</div>
</div>
</div>